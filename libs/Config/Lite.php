...
$configPath = __DIR__ . '/Lite/';
require_once $configPath . 'Exception.php';
require_once $configPath . 'Exception/InvalidArgument.php';
require_once $configPath . 'Exception/Runtime.php';
require_once $configPath . 'Exception/UnexpectedValue.php';
